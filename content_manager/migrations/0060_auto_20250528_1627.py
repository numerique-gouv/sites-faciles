...
from wagtail_dsfr.content_manager.models import ContentPage, CatalogIndexPage
from itertools import chain


def migrate_obsolete_fields(apps, schema_editor):
    ContentPage = apps.get_model("wagtail_dsfr_content_manager", "ContentPage")
    CatalogIndexPage = apps.get_model("wagtail_dsfr_content_manager", "CatalogIndexPage")
