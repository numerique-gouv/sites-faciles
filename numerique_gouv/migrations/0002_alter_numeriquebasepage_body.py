                        ...
                        wagtail.blocks.StructBlock(
                            [
                                ...
                                (
                                    "top_right_image",
                                    wagtail.images.blocks.ImageChooserBlock(
                                        help_text="Secondary card image", required=True
                                    ),
                                ),
                                (
                                    "top_right_text",
                                    wagtail.blocks.RichTextBlock(help_text="Secondary card text", required=True),
                                ),
                                (
                                    "top_right_button_label",
                                    wagtail.blocks.TextBlock(help_text="Secondary card button label", required=True),
                                ),
                                (
                                    "top_right_page_link",
                                    wagtail.blocks.PageChooserBlock(help_text="Link to a page", required=False),
                                ...
                                (
                                    "bottom_right_image",
                                    wagtail.images.blocks.ImageChooserBlock(
                                        help_text="Tertiary card image", required=True
                                    ),
                                ),
                                (
                                    "bottom_right_text",
                                    wagtail.blocks.RichTextBlock(help_text="Tertiary card text", required=True),
                                ),
                                (
                                    "bottom_right_button_label",
                                    wagtail.blocks.TextBlock(help_text="Tertiary card button label", required=True),
                                ),
                                (
                                    "bottom_right_page_link",
                                    wagtail.blocks.PageChooserBlock(help_text="Lien vers une page", required=False),
                                ),
                                (
