...
class Migration(migrations.Migration):
    dependencies = [
        ("numerique_gouv", "0003_alter_numeriquebasepage_body"),
    ]
                        ...
                        wagtail.blocks.StructBlock(
                            [
                                (
                                    "main_image",
                                    wagtail.images.blocks.ImageChooserBlock(
                                        help_text="Main card image", required=True
                                    ),
                                ),
                                ("main_title", wagtail.blocks.TextBlock(help_text="Main card title", required=True)),
                                ("main_text", wagtail.blocks.RichTextBlock(help_text="Main card text", required=True)),
                                (
                                    "main_page_link",
                                    wagtail.blocks.PageChooserBlock(help_text="Link to a page", required=False),
                                ),
                                (
                                    "main_url_link",
                                    wagtail.blocks.URLBlock(help_text="Link to an external URL", required=False),
                                ),
                                (
                                    "top_right_image",
                                    wagtail.images.blocks.ImageChooserBlock(
                                        help_text="Top right card image", required=True
                                    ),
                                ),
                                (
                                    "top_right_text",
                                    wagtail.blocks.RichTextBlock(help_text="Top right card text", required=True),
                                ),
                                (
                                    "top_right_button_label",
                                    wagtail.blocks.TextBlock(help_text="Top right card button label", required=True),
                                ),
                                (
                                    "top_right_page_link",
                                    wagtail.blocks.PageChooserBlock(help_text="Link to a page", required=False),
                                ...
                                (
                                    "bottom_right_image",
                                    wagtail.images.blocks.ImageChooserBlock(
                                        help_text="Bottom right card image", required=True
                                    ),
                                ),
                                (
                                    "bottom_right_text",
                                    wagtail.blocks.RichTextBlock(help_text="Bottom right card text", required=True),
                                ),
                                (
                                    "bottom_right_button_label",
                                    wagtail.blocks.TextBlock(
                                        help_text="Bottom right card button label", required=True
                                    ),
                                ),
                                (
