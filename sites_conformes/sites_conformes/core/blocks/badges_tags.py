...
class BadgeBlock(blocks.StructBlock):
    ...
    class Meta:
        template = "sites_conformes_core/blocks/badge.html"
...
class BadgesListBlock(blocks.StreamBlock):
    ...
    class Meta:
        icon = "list-ul"
        template = "sites_conformes_core/blocks/badges_list.html"
...
class TagBlock(blocks.StructBlock):
    ...
    class Meta:
        template = "sites_conformes_core/blocks/tag.html"
...
class TagListBlock(blocks.StreamBlock):
    ...
    class Meta:
        icon = "list-ul"
        template = "sites_conformes_core/blocks/tags_list.html"
